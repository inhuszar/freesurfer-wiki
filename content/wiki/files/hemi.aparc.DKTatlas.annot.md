...
mandatory_for: []
optional_for:
  - "[[wiki/pipelines/recon-all|recon-all]] autorecon3: CortParc3 (run by default)"
editable: false
related:
  - "[[hemi.aparc.annot]]"
...
[[wiki/pipelines/recon-all|recon-all]] autorecon3, **CortParc3** stage (`-cortparc3`). Touch sentinel: `touch/$hemi.aparc2.touch`.
