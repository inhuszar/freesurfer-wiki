...
- An FSGDF design file or OLS single group mean specification
...
| `--fsgd1 <file>` | path | — | FSGD design file for mode 1. |
| `--fsgd2 <file>` | path | — | FSGD design file for mode 2. |
...
**High confidence:** Complete flag list verified from `parse_commandline()` in source. Class structure and permutation type values (0/1/2/3) confirmed.
