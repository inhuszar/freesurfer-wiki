...
| `--remove-holes-islands` | — | Remove holes and isolated islands (surface mode only) |
| `--dilate` | `ndilations` | Number of label dilations (surface mode only) |
| `--erode` | `nerosions` | Number of label erosions (surface mode only) |
| `--help` | — | Print help |
...
- `--remove-holes-islands`, `--dilate`, and `--erode` require `--surf` mode.
